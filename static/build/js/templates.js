angular.module('kitin').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('/snippets/modal-holdings',
    ...
    "  <button class=\"btn btn-purple btn-submit\" ng-class=\"classes.saveStatus\" data-ng-click=\"saveHolding(holding, $event)\" data-ng-show=\"holding\" data-ng-disabled=\"modifications.holding.saved\">\n" +
