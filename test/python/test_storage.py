...
def test_save_draft():
    ...
    with open(basedir + "some/path/" + user_id + "/bib/7149593", "r") as f:
        ...
        assert json_data['etag'] == "1362044230872"
...
def test_get_draft_json():
    with open(basedir + "fixture/7149593_formatted.json", "r") as f:
        ...
        assert our_json_data['document']['@id'].rsplit("/",1)[1] == '7149593'
...
def test_get_drafts():
    with open(basedir + "fixture/7149593_formatted.json", "r") as f:
        data = f.read()
        storage.save_draft(user_id, "bib", "1234567", data, "1362044230872")
        storage.save_draft(user_id, "other", "987654", data, "1362044230872")
